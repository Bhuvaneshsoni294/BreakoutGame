...
function draw() {
  ...
  if(gameState === "serve" )
  {
    // write code that will happen in serve mode 
    
    //display Welcome text 
    
    textSize(20);
    stroke("red");
    text("Welcome! Press Enter to start the Game " ,30,200);
  ...
  if (gameState === "play")
  {
    // write code that will happen in play mode 
  ...
  if (gameState === "end")
  {
    // write code that will happen in end  mode 
  }
